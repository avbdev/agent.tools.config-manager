...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'REVEAL', 'LOGIN', 'LOGOUT', 'ROLE_CHANGE', 'KEY_ROTATION');
...
-- CreateIndex
CREATE INDEX "Setting_orgId_service_idx" ON "Setting"("orgId", "service");

-- CreateIndex
CREATE INDEX "Setting_orgId_environment_idx" ON "Setting"("orgId", "environment");

-- CreateIndex
CREATE INDEX "Setting_deletedAt_idx" ON "Setting"("deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "Setting_orgId_service_key_environment_key" ON "Setting"("orgId", "service", "key", "environment");
...
-- AddForeignKey
ALTER TABLE "Setting" ADD CONSTRAINT "Setting_orgId_fkey" FOREIGN KEY ("orgId") REFERENCES "Org"("id") ON DELETE CASCADE ON UPDATE CASCADE;
